...
export function SideBar() {
    return (
        <nav className="bg-dark" style={{ maxWidth: "20vh", height: "100vh" }}>
            <div className="d-flex flex-column text-center align-items-center justify-content-center" style={{ maxWidth: "20vh", height: "100vh" }}>
                <div className="nav flex-column nav-pills me-3 mb-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
